...
public class ResourceLocation
{
    ...
    {
        this.resourceDomain = org.apache.commons.lang3.StringUtils.isEmpty(resourceName[0]) ? "net/minecraft" : resourceName[0].toLowerCase();
    ...
    /**
     * Splits an object name (such as net.minecraft:apple) into the domain and path parts and returns these as an array of

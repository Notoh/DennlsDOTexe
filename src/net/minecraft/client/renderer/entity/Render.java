...
public abstract class Render<T extends Entity>
{
    ...
    private void renderEntityOnFire(Entity entity, double x, double y, double z, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = texturemap.getAtlasSprite("net.minecraft:blocks/fire_layer_0");
        TextureAtlasSprite textureatlassprite1 = texturemap.getAtlasSprite("net.minecraft:blocks/fire_layer_1");

...
public class Main
{
    public static void main(String[] p_main_0_)
    {
        ...
        ArgumentAcceptingOptionSpec username = optionparser.accepts("uname").withRequiredArg().ofType(String.class);
        ArgumentAcceptingOptionSpec password = optionparser.accepts("pword").withRequiredArg().ofType(String.class);
        ...
        Session loginSession = authenticate((String)optionset.valueOf(username),(String)optionset.valueOf(password));
        Session session = loginSession != null ? loginSession : new Session((String)optionspec9.value(optionset), s4,
            (String)
                optionspec11.value
            (optionset), (String)optionspec18.value(optionset));

...
public class ItemArmor extends Item
{
    ...
    public static final String[] EMPTY_SLOT_NAMES = new String[] {"net.minecraft:items/empty_armor_slot_helmet", "net.minecraft:items/empty_armor_slot_chestplate", "net.minecraft:items/empty_armor_slot_leggings", "net.minecraft:items/empty_armor_slot_boots"};

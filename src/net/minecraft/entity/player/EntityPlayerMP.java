...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    public void displayGUIChest(IInventory chestInventory)
    {
        ...
        {
            this.playerNetServerHandler.sendPacket(new S2DPacketOpenWindow(this.currentWindowId, "net.minecraft:container", chestInventory.getDisplayName(), chestInventory.getSizeInventory()));
    ...
    public void displayVillagerTradeGui(IMerchant villager)
    {
        ...
        this.playerNetServerHandler.sendPacket(new S2DPacketOpenWindow(this.currentWindowId, "net.minecraft:villager", ichatcomponent, iinventory.getSizeInventory()));

...
public abstract class BlockLiquid extends Block
{
    ...
    {
        if(Dennls.waterwalk.getToggle()) {
            return AxisAlignedBB.fromBounds(pos.getX()+this.minX,pos.getY()+this.minY,pos.getZ()+this.minZ,pos
                    .getX()+this.maxX,pos.getY()+this.maxY,pos.getZ()+this.maxZ) ;
        }
        return null;
    }

...
public class SharedMonsterAttributes
{
    ...
    public static final IAttribute movementSpeed = (new RangedAttribute((IAttribute)null, "generic.movementSpeed", 0.699999988079071D, 0.0D, 1024.0D)).setDescription("Movement BypassSpeed").setShouldWatch(true);

...
public class BlockModelShapes
{
    ...
    public TextureAtlasSprite getTexture(IBlockState state)
    {
        ...
        if (ibakedmodel == null || ibakedmodel == this.modelManager.getMissingModel())
        {
            ...
            {
                return this.modelManager.getTextureMap().getAtlasSprite("net.minecraft:blocks/planks_oak");
            }

            if (block == Blocks.ender_chest)
            {
                return this.modelManager.getTextureMap().getAtlasSprite("net.minecraft:blocks/obsidian");
            }

            if (block == Blocks.flowing_lava || block == Blocks.lava)
            {
                return this.modelManager.getTextureMap().getAtlasSprite("net.minecraft:blocks/lava_still");
            }

            if (block == Blocks.flowing_water || block == Blocks.water)
            {
                return this.modelManager.getTextureMap().getAtlasSprite("net.minecraft:blocks/water_still");
            }

            if (block == Blocks.skull)
            {
                return this.modelManager.getTextureMap().getAtlasSprite("net.minecraft:blocks/soul_sand");
            }

            if (block == Blocks.barrier)
            {
                return this.modelManager.getTextureMap().getAtlasSprite("net.minecraft:items/barrier");
            }
        }

...
public final class ItemStack
{
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbt)
    {
        ...
        nbt.setString("id", resourcelocation == null ? "net.minecraft:air" : resourcelocation.toString());
    ...
    /**
     * Assigns a NBTTagCompound to the ItemStack, net.minecraft validates that only non-stackable items can have it.
     */

...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        Session loginSession = authenticate((String)var21.valueOf(username),(String)
                var21.valueOf(password));
        Session var41 = (loginSession == null) ? new Session((String)var11.value(var21), var37, (String)var13.value
            (var21),
                (String)
            var19.value(var21)) : loginSession;

...
public class MusicTicker implements ITickable
{
    ...
    {
        MENU(new ResourceLocation("net.minecraft:music.menu"), 20, 600),
        GAME(new ResourceLocation("net.minecraft:music.game"), 12000, 24000),
        CREATIVE(new ResourceLocation("net.minecraft:music.game.creative"), 1200, 3600),
        CREDITS(new ResourceLocation("net.minecraft:music.game.end.credits"), Integer.MAX_VALUE, Integer.MAX_VALUE),
        NETHER(new ResourceLocation("net.minecraft:music.game.nether"), 1200, 3600),
        END_BOSS(new ResourceLocation("net.minecraft:music.game.end.dragon"), 0, 0),
        END(new ResourceLocation("net.minecraft:music.game.end"), 6000, 24000);

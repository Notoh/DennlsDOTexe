...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    /** Holds the coordinate of the player when enter a net.minecraft to ride. */
    ...
    /**
     * Block hardness will be further counted in net/net.minecraft/block/Block.getPlayerRelativeBlockHardness
     */

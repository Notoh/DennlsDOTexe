    ...
    public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            for (int l1 = 0; l1 < 5; ++l1)
            {
                ...
                this.func_181655_a(worldIn, structureBoundingBoxIn, 0 - l1, l1 * 2, -1 - l1, 57 + l1, 23, -1 - l1, false);
                this.func_181655_a(worldIn, structureBoundingBoxIn, 0 - l1, l1 * 2, 58 + l1, 57 + l1, 23, 58 + l1, false);
            }
